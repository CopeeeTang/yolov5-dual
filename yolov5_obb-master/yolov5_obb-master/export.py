...
@torch.no_grad()
def run(data=ROOT / 'data/visdrone.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'runs/train/exp45/weights/visdrone_obb.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp45/weights/visdrone_obb.pt', help='model.pt path(s)')
