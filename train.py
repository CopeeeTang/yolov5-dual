...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp10/weights/best.pt', help='initial weights path')#模型参数初始化
    parser.add_argument('--cfg', type=str, default=ROOT/'models/attentionuav7.yaml', help='model.yaml path')#训练模型
    ...
    parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')#利用保存的模型继续训练
