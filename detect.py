...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/dual.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='C:/Users/33498/Desktop/Summer/PearlGAN-main/FLIR_ADAS_v2/video_rgb_test/data', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source2', type=str, default='C:/Users/33498/Desktop/Summer/PearlGAN-main/FLIR_ADAS_v2/video_thermal_test/data', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='(optional) dataset.yaml path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[1024], help='inference size h,w') #网络输入图片的大小
    parser.add_argument('--conf-thres', type=float, default=0.10, help='confidence threshold') #置信度阈值
